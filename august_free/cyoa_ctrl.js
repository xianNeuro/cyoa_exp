...
var response_text = "";
var key_flag = 0;
var setsplit = [18,77,307];//scenes where sec2-4 split into sl1/2/3 based on choices in sec1
var endsplit = [643]; //this is the point to go into 1 of 2 
var sl = 1; //now restrict to just sl1 //2+Math.round(Math.random()); //now restrict to sl2/3;  //Math.floor(Math.random() * 3) + 1; //random number: 1,2,3
