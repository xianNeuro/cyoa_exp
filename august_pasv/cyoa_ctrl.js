...
var mycounterbalance = Math.floor(Math.random() * 18) + 1; // get random integer between 1-18
      ...
      setTimeout(function () { //set a small delay before the next key-press to proceed to the next sentence
        ...
        if (pracInstr==true){ //if this is the practice story 
          ...
          if (prac_story.row[index].Choice=="N") { //if this is not a choice point
            ...
            //update element visibility
            $('#Response_Label1').hide(); //hide element 
            //arrow+label set top: 77% = option1; 82% = option2
            if (prac_choice_vector[choiceIndex]==1){ 
              $("#Arrow").css("top", "77%");
              $("#Label").css("top", "77%");
            }else if (prac_choice_vector[choiceIndex]==2){
              $("#Arrow").css("top", "82%");
              $("#Label").css("top", "82%");
            }
            $('#Arrow').show();
            ...
            document.getElementById('simpleList').style.pointerEvents="";
            if (prac_choice_vector[choiceIndex]==1){
              document.getElementById('Button_1').style.pointerEvents="";
              document.getElementById('Button_2').style.pointerEvents="none";
            }else if (prac_choice_vector[choiceIndex]==2){
              document.getElementById('Button_1').style.pointerEvents="none";
              document.getElementById('Button_2').style.pointerEvents="";
            };
          ...
          if (story.row[index].Choice=="N") { //if this is not a choice point
            ...
            $('#Response_Label1').hide(); //hide element
            //arrow+label set top: 77% = option1; 82% = option2
            if (choice_vector[choiceIndex]==1){ 
              $("#Arrow").css("top", "77%");
              $("#Label").css("top", "77%");
            }else if (choice_vector[choiceIndex]==2){
              $("#Arrow").css("top", "82%");
              $("#Label").css("top", "82%");
            }
            $('#Arrow').show();
